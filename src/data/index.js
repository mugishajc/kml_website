export const clientLogos = [
  {
    src: "/clients/1.svg",
    alt: "Client Logo 1",
    className: "shrink-0 self-stretch aspect-[3.57] w-[93px]",
  },
  {
    src: "/clients/2.svg",
    alt: "Client Logo 2",
    className: "shrink-0 max-w-full aspect-[5.26] w-[101px]",
  },
  {
    src: "/clients/3.svg",
    alt: "Client Logo 3",
    className: "shrink-0 aspect-[4.17] w-[78px]",
  },
  {
    src: "/clients/4.svg",
    alt: "Client Logo 4",
  ...
  },
  {
    ...
    alt: "Client Logo 5",
    className:
      "shrink-0 self-stretch my-auto max-w-full aspect-[5.26] w-[105px] max-md:mt-10",
  },
  {
    src: "/clients/1.svg",
    alt: "Client Logo",
    className: "shrink-0 max-w-full aspect-[3.85] w-[133px] max-md:mt-10",
  },
];
